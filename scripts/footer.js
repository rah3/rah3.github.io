            ...
            <div class="container text-center">
                <div class="row">
                    <div class="col-md-4 mb-4">
                        ...
                        <p class="small mb-1"><a href="https://www.linkedin.com/in/rahiedatta" target="_blank" class="text-white-50 text-decoration-none">LinkedIn Profile</a></p>
                        <p class="small"><a href="https://github.com/rah3" target="_blank" class="text-white-50 text-decoration-none">GitHub Repository</a></p>
                    </div>

                    <div class="col-md-4 mb-4">
                        <h5 class="fw-bold text-primary">Rahie Datta</h5>
                        <p class="small text-white-50">Fourth Year Computer Science Student at Carleton University</p>
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <ul class="list-unstyled small">
                            ...
                            <li><a href="#skills-profile" class="text-white-50 text-decoration-none">Skills Profile</a></li>
